                            ...
                            <div class="form-group">
                                <div class="align-input">
                                    <i class="fa-solid fa-envelope fa-lg" style="color: #75777a;"></i><input
                                        class="form-control obrigatorio" type="text" placeholder="Sua Senha"
                                        name="senha-aluno">
                                </div>
                            </div>
                        ...
                        <form action="back-end/login/valida_login.php" method="post">
                            <div class="form-group-login">
                                <div class="align-input-login">
                                    <i class="fa-solid fa-envelope fa-lg" style="color: #75777a;"></i><input
                                        class="form-control-login obrigatorio" placeholder="Seu Email" type="email"
                                        name="email-professor" id="email-professor">
                                </div>

                                <div class="align-input-login">
                                    <i class="fa-solid fa-lock fa-lg" style="color: #75777a;"></i><input
                                        class="form-control-login obrigatorio" placeholder="Sua Senha" type="password"
                                        name="senha-professor" id="password">
