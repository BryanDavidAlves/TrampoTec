        ...
        <form class="form-requisitos">
            <div class="inputs-dialog">
                <span class="nav-dialog">
                    ...
                    <b>Editar perfil</b>
                    <button class="salvar-dialog">SALVAR</button>
                </span>
                <div class="componentes-perfil-dialog">
                    <label for="imagem-fundo" style="cursor: pointer;"> <img class="fundo-empresa-dialog" src="./img/fundo-empresa.jpg"></label>
                    <input id="imagem-fundo" type="file" style="display: none;">
                    <div class="conteiner-descricao-dialog">
                        <?php foreach ($resultado as $resultado) { ?>
                            ...
                            <input id="imagem-perfil" type="file" style="display: none;">

                    </div>
                </div>

                <div class="dialog-corpo-inputs">
                    <input class="campos-inputs-text" placeholder="<?= $resultado[3] ?>" type="text">
                    <input class="campos-inputs-text" placeholder="<?= $resultado[1] ?>" type="text">
                    <input class="campos-inputs-text" placeholder=" <?= $resultado[4] ?>" type="text">
                    <input class="campos-inputs-text" placeholder="" type="text">
                    <input class="campos-inputs-text" placeholder="" type="text">
                    <input class="campos-inputs-text" placeholder="" type="text">
                    <input class="campos-inputs-text" placeholder="" type="text">
                    <input class="campos-inputs-text" placeholder="" type="text">
            ...
            <div class="card">
                <div class="card-corpo">
                    <div class="card-itens">
                        ...
                        <span> <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14632.732484011547!2d-46.67088371218347!3d-23.525915236928455!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94ce580f7c039a63%3A0xcf365b1a0b3158be!2sBarra%20Funda%2C%20S%C3%A3o%20Paulo%20-%20SP!5e0!3m2!1spt-BR!2sbr!4v1690229585202!5m2!1spt-BR!2sbr" width="auto" height="auto" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe> </span>
